 ...
 * consent-manager.js
 * ------------------------------------------------------------------
 * Owns the consent lifecycle:
 *   - Reads/writes consent choices (localStorage, versioned)
 *   - Renders the banner + preferences modal
 *   - Broadcasts "consent:updated" whenever consent changes
 * ------------------------------------------------------------------
 */
