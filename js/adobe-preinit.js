 ...
 * adobe-preinit.js
 * ------------------------------------------------------------------
 * A tiny denied-by-default Adobe opt-in bootstrap that loads before
 * VisitorAPI.js / AppMeasurement.js. It keeps a consent surface in
 * place even before the real library finishes booting.
 * ------------------------------------------------------------------
 */

(() => {
  const STORAGE_KEY = 'nt_consent_v1';
